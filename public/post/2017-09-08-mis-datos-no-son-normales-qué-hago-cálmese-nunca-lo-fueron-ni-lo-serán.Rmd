---
title: '¡Mis datos no son normales! ¿Qué hago?...Cálmese, nunca lo fueron...
ni lo serán'
author: cgomez
date: '2017-09-08'
...
categories:
  ...
  - normalidad
tags: []
summary: 'En este post discutiremos el concepto de normalidad y su aplicación
en química. Daremos algunas luces sobre qué hacer cuándo los datos experimentales 
no soportan el supuesto de normalidad'
---
...
```{r plotnormal, echo = F, fig.cap = 'Distribución Normal con media = 0 y sd = 1 '}
...
validación de procesos farmacéuticos? 1313{{% /alert %}}
...
Para finalizar veamos en acción de estos métodos: Bootstrap. 
