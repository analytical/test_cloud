...
tags:
  ...
  - R
  - GUM
summary: 'En este post introductorio validaremos los cálculos de incertidumbre 
de una operación analítica realizados de acuerdo a la guía GUM, 
mediante el Método de Monte Carlo. De esta forma Ud. podrá evidenciar, por 
ejemplo, ante un amable auditor de la norma 17025, que 
sus cálculos de incertidumbre en Excel están "validados" ¿o no recuerda el 
numeral 5.4.7?.'
---
...
knitr::include_graphics('/img/pipeta.jpg')
...
simulados, es decir, $u_{f}^{MC} = $ `sd(f.sim)` = `r round(sd(f.sim), 5)`.
...
La figura \@ref(fig:quantilosfig) muestra este intervalo en el histograma de 
los datos simulados:
...
hemos hecho el test en forma manual. En el próximo post utilizaremos
