...
# instrumental y0, junto con la incertidumbre estándar de calibración u(x0) y
# expandida U(x0):
...
- `$Confidence Limits` es simplemente $x0 \pm U(x0)$ ppm.
...
incertidumbre... lo cual todos los químcos sabemos que es ¡Farso, farso!
...
de estándares: equivocación en el aforo, no considerar la pureza del 
