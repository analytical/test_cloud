...
tags:
  ...
  - incertidumbre
  - repetibilidad
summary: 'En este post presentaremos dos métodos estadísticos para establecer
la máxima diferencia tolerable entre duplicados de análisis. Este criterio de
aceptación nos dará una una base para la construcción de cartas control de 
precisión'
---
...
Puede descargar esta base de datos desde este [link](https://1drv.ms/x/s!AuF6FPVWruwDtoUe9jzqyzQ_q1HFwg). 
...
(multiplique 0,15 % Cu por la millones de toneladas que se transan en el mercado...a 3 US/libra no es un asunto trivial).
...
![Diseño Experimental](/img/doe.png){width=700px}
