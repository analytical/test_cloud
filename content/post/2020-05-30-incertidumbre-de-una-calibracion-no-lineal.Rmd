...
categories: []
tags: [incertidumbre, calibracion]
subtitle: 'Método GUM y Monte Carlo -- Norma ISO 8466:2'
summary: 'Se comparan tres métodos para estimar la incertidumbre de una calibración no lineal: Norma ISO 8466-2, GUM y Método de Monte Carlo'
authors: []
...
donde $y_{0}$ es la señal inestrumental de la muestra problema.
...
¡Listo! sólo nos falta ahora evaluar las expresiones. Pero como soy flojo 
...
```{r}
# Simularemos p = 1000 curvas de calibración cuadráticas a partir de los datos 
# empíricos 
...
package `MASS` el cual permite generar muetras aleatorias multivariadas 
...
la concentración, basta clacular la desviación estándar de esa columna:
