...
La tabla \@ref(tab:tabla) muestra los datos de una curva de calibración para la determinación de cobre en mineral por AAS:
...
knitr::kable(d,
             caption = 'Curva de Calibración Cu en AAS',
             booktabs = T,
             digits = 4,
             align = 'c',
