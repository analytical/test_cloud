...
tags:
  ...
  - adicion conocida
  - R
summary: 'En este post trataremos el tema del efecto matriz de un método 
analítico y cómo detectarlo estadísticamente mediante el análisis de covarianza'
---
...
en teoría, es producida sólo por el analito de interés. Otro efecto a considerar
es que la matriz ejerce un efecto protector del analito, especialmente en
métodos que utilizan cromatografía gaseosa.
...
el analito. De esta forma, la señal analítica de estos calibrantes en matriz, está 
...
knitr::include_graphics('/img/mosaplot.png')
...
knitr::include_graphics('/img/c0adicion.png')
```
...
knitr::include_graphics('/img/doeadicion.png')
...
knitr::include_graphics('/img/tabla_mosa.png')
```
