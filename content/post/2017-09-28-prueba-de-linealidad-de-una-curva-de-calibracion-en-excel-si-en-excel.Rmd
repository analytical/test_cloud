...
tags:
  - linealidad
summary: 'En este post implementaremos el test de linealidad de Mandel en 
Excel, para evaluar la hipótesis de linealidad de una curva de calibración 
...
demostrado previamente esta hipótesis{{% /alert %}}
